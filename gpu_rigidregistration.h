...
public:
    ...
    typedef itk::GPU3DRigidSimilarityMetric<ImageType, ImageType>
                                                        GPUCostFunctionType;
    ...
    void SetItkSourceImage(ImageType::Pointer image) { this->m_itkSourceImage = image; }
    void SetItkTargetImage(ImageType::Pointer image) { this->m_itkTargetImage = image; }
...
private:
    ...
    ImageType::Pointer m_itkSourceImage;
